...
Finished unconvert
Check(s) produced output: [unconvert]
`,
			},
			{
...
`,
	...
	godel/config/check-plugin.yml: failed to upgrade configuration: failed to upgrade check "unconvert" legacy configuration: failed to upgrade asset configuration: unconvert-asset does not support legacy configuration with a non-empty "args" field
`,
				WantFiles: map[string]string{
					"godel/config/check.yml": `
checks:
...
`,
				...
				WantError: true,
				WantOutput: `Failed to upgrade configuration:
	godel/config/check-plugin.yml: failed to upgrade check "unconvert" configuration: failed to upgrade asset configuration: unconvert-asset does not currently support configuration
`,
				WantFiles: map[string]string{
					"godel/config/check-plugin.yml": `
checks:
